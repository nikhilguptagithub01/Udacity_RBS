...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:default123@localhost:5432/todoapp'
...
@app.route('/')
def index():
  return render_template('indexlist.html', todos=Todo.query.order_by('id').all())